        ...
        <div className="fixed inset-0 bg-white/50 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-2xl mx-4 max-h-[80vh] overflow-hidden">
                ...
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-gray-900">Create New PG Community</h2>
                    <button
                        onClick={onCancel}
                ...
                <div className="mb-6">
                    <p className="text-gray-600 text-sm">
                        Create a new PG community to start managing your residents and facilities.
                    </p>
                </div>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-200 mt-6">
                    <div className="text-sm text-gray-600">
                        Fill in the required fields to create your community
                    </div>
